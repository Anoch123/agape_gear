    ...
    return (
        <section className="py-16 bg-gray-100">
            <div className="w-full">
                ...
                <div
                    className="flex justify-between items-center mb-8p-4 md:p-0 ml-3"
                    style={{
                ...
                <div
                    ref={scrollRef}
                    className="flex gap-4 overflow-x-auto mt-6"
                    style={{
                        scrollbarWidth: 'none',
                ...
                >
                    {products.map((product, index) => (
                        <div
                            key={product.id}
                            className={`flex-shrink-0 w-[280px] md:w-[320px] lg:w-[360px] ${index === 0 ? 'ml-[9px] md:ml-0' : ''}`}
                        >
